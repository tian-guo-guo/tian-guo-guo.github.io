...
| 标准 | 说明                                                         | 备注                                                         |
| :--- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| 结构 | 结构用于对**网页元素**进行整理和分类，咱们主要学的是HTML。   | ![img](/Users/suntian/codes/前端资料/01-03 前端开发基础/01-HTML资料/01.HTML-Day01/笔记/media/htmll.jpg?lastModify=1607647221) |
| 表现 | 表现用于设置网页元素的版式、颜色、大小等**外观样式**，主要指的是CSS | ![img](/Users/suntian/codes/前端资料/01-03 前端开发基础/01-HTML资料/01.HTML-Day01/笔记/media/css.jpg?lastModify=1607647221) |
| 行为 | 行为是指网页模型的定义及**交互**的编写，咱们主要学的是 Javascript | ![img](/Users/suntian/codes/前端资料/01-03 前端开发基础/01-HTML资料/01.HTML-Day01/笔记/media/search.gif?lastModify=1607647221) |
...
![image-20201211085047577](https://cdn.jsdelivr.net/gh/tian-guo-guo/cdn@master/assets/picgoimg/20201211085047.png)
...
![image-20201211085400671](https://cdn.jsdelivr.net/gh/tian-guo-guo/cdn@master/assets/picgoimg/20201211085400.png)
...
<!doctype>声明位于文档的最前面，在html之前显示。用于告诉浏览器的解析器，用什么文档类型规范来解析文档。严格模式默认用浏览器支持的最高版本解析，混合模式以宽松的向后兼容的方式解析，do ctype不存在或格式不正确时会让文档以混杂模式呈现
...
### 什么是HTML5与HTML5拓展了哪些内容

`HTML5` 定义了 `HTML` 标准的最新版本，是对 `HTML` 的第五次重大修改，号称下一代的 `HTML` 

`HTML5` 、`CSS3` 、`javascript`, 这也是广义上的 `HTML5`

`HTML5` 拓展了哪些内容：

- 语义化标签、本地存储、兼容特性、`2D`、`3D` 

    、动画、过渡、`CSS3` 特性、性能与集成

### HTML5新增了语义化标签、多媒体音频标签、input标签、表单标签

1. header、nav、artivale、section、aside、footer

![image-20201211093902938](https://cdn.jsdelivr.net/gh/tian-guo-guo/cdn@master/assets/picgoimg/20201211093903.png)
